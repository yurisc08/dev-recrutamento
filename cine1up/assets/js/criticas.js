...
(function () {
  ...
  function montarFiltros() {
    ...
    if (!box) return;
    const cats = ['Tudo'].concat(window.CINE1UP.CATEGORIAS);
  ...
  function montarPaginacao() {
    ...
    if (!box) return;
    const tam = window.CINE1UP.PAGE_SIZE;
  ...
  async function carregar() {
    ...
    try {
      ...
      alvo.innerHTML = '<div class="empty" style="grid-column:1/-1">Erro ao carregar as matérias</div>';
    } finally {
