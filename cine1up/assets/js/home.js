...
(function () {
  ...
  /* ---------- Vitrines do TMDB e manchetes ---------- */
  function montarTMDB() {
    if (!window.Vitrine || !window.TMDB) return;
    window.Vitrine.montar('[data-vitrine-cartaz]', () => window.TMDB.emCartaz(), { quantos: 12 });
    window.Vitrine.montar('[data-vitrine-series]', () => window.TMDB.seriesEmAlta(), { quantos: 12 });
